...
static const pt_class_template pt_class_templates[PT_CLASS_COUNT] = {
	...
	/* PT_CLASS_ANALYSED_CODE_EXCEPTION */ {"analysedCodeException", "PHPStan\\AnalysedCodeException"},
	/* PT_CLASS_IDENTIFIER_NOT_FOUND */ {"identifierNotFound", "PHPStan\\BetterReflection\\Reflector\\Exception\\IdentifierNotFound"},
	/* PT_CLASS_UNABLE_TO_COMPILE_NODE */ {"unableToCompileNode", "PHPStan\\BetterReflection\\NodeCompiler\\Exception\\UnableToCompileNode"},
	/* PT_CLASS_CIRCULAR_REFERENCE */ {"circularReference", "PHPStan\\BetterReflection\\Reflection\\Exception\\CircularReference"},
	/* PT_CLASS_FILE_DEPENDENCIES_RULE_ERROR */ {"fileDependenciesRuleError", "PHPStan\\Rules\\FileDependenciesRuleError"},
	/* PT_CLASS_ANALYSER_ERROR */ {"analyserError", "PHPStan\\Analyser\\Error"},
	/* PT_CLASS_INTERNAL_ERROR */ {"internalError", "PHPStan\\Analyser\\InternalError"},
